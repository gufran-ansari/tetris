...
def draw_text_middle(surface, text, size, color):
    font = pygame.font.SysFont('comicsans', size, color)
...
def draw_grid(surface, grid):
    ...
    for i in range(len(grid)):
        ...
        for j in range(len(grid[i])):
            pygame.draw.line(surface, (128, 128, 128), (start_x +
                                                        j * block_size, start_y), (start_x + j * block_size, start_y + play_height))
...
def draw_next_shape(shape, surface):
    ...
    start_x = top_left_x + play_width + 45
    ...
    surface.blit(label, (start_x + 25, start_y - 50))
...
def draw_window(surface, grid, score=0, last_score=0):
    ...
    start_y = top_left_y + play_height / 2 - 50
    surface.blit(label, (start_x + 20, start_y + -175))
